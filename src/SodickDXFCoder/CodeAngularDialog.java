...
public class CodeAngularDialog extends JDialog {
	...
	private static final String START_SECTION_FILE_NAME = "angle.txt";
	 ...
	 * Create the dialog.
	 */
	public CodeAngularDialog(Chain chainToCode) {
		super();
		...
		panel_1.setBorder(new TitledBorder(null, "Lutning", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_1.setBounds(182, 10, 148, 76);
		contentPanel.add(panel_1);
		panel_1.setLayout(null);
		
		rdbtnAngleDirLeft = new JRadioButton("Lutning åt vänster");
		rdbtnAngleDirLeft.setBounds(6, 20, 136, 23);
		panel_1.add(rdbtnAngleDirLeft);
		...
		panel_1.add(rdbtnAngleDirRight);
